...
void main() {
  group('CustomIconButton Widget Tests', () {
    ...
    testWidgets('CustomIconButton throws assertion error for null icon', (WidgetTester tester) async {
      expect(
        () => CustomIconButton(
          onPressed: () {},
          // No icon provided
    ...
    testWidgets('CustomIconButton throws assertion error for null onPressed', (WidgetTester tester) async {
      expect(
        () => CustomIconButton(
          icon: Icons.add,
