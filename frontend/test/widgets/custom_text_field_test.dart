...
void main() {
  group('CustomTextField Widget Tests', () {
    ...
    testWidgets('CustomTextField throws assertion error for empty label', (WidgetTester tester) async {
      expect(
        () => CustomTextField(
          controller: TextEditingController(),
          // No label provided
    ...
    testWidgets('CustomTextField throws assertion error for null controller', (WidgetTester tester) async {
      expect(
        () => CustomTextField(
          label: 'Test',
