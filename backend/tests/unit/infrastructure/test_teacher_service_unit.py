...
class TestTeacherServiceUnit:
    ...
    def mock_repository(self):
        ...
        return Mock(spec=TeacherRepository)
    ...
    async def test_create_teacher_success(self, teacher_service, mock_repository, sample_teacher_data):
        ...
        # Assertions
        mock_repository.create.assert_called_once_with(sample_teacher_data)
    ...
    async def test_update_teacher_success(self, teacher_service, mock_repository):
        ...
        mock_repository.update.assert_called_once_with(teacher_id, update_data)
    ...
    async def test_get_teacher_by_teacher_id_success(self, teacher_service, mock_repository):
        ...
        mock_repository.get_by_teacher_id.return_value = mock_teacher
        
        result = await teacher_service.get_teacher_by_teacher_id(teacher_id)
        
        mock_repository.get_by_teacher_id.assert_called_once_with(teacher_id)
        assert result is not None
    ...
    async def test_get_teacher_statistics_success(self, teacher_service, mock_repository):
        ...
        mock_repository.get_teacher_statistics.return_value = mock_stats
        
        result = await teacher_service.get_teacher_statistics(teacher_id)
        
        mock_repository.get_teacher_statistics.assert_called_once_with(teacher_id)
    ...
    async def test_get_teachers_by_specialization_success(self, teacher_service, mock_repository):
        ...
        mock_repository.get_by_specialization.return_value = mock_teachers
        
        result = await teacher_service.get_teachers_by_specialization(specialization)
        
        mock_repository.get_by_specialization.assert_called_once_with(specialization)
        assert len(result) == 1
    ...
    async def test_teacher_not_found_error(self, teacher_service, mock_repository):
        ...
        with pytest.raises(NotFoundError):
            await teacher_service.get_teacher_by_id(teacher_id)
